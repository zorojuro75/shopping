...
const Product = (props: Props) => {
  return (
    <div className="bg-white flex flex-col rounded-sm hover:shadow-lg h-96 pt-5">
      ...
      <div className="text-2xl font-bold capitalize text-center flex-1 mx-4 flex flex-col justify-center items-center gap-2">
        <div>{props.name}</div>
      ...
      <button className="rounded-b-sm bg-[#31C8A5] hover:bg-[#3aa78e] h-10 flex items-center justify-center">
        Add to Cart
      </button>
    </div>
  );
