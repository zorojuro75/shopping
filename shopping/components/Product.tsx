...
const Product = (props: Props) => {
  return (
    <div className="bg-white flex flex-col rounded-md hover:shadow-xl h-96 pt-5">
      <div className="h-44 bg-black bg-opacity-10 flex justify-center items-center mx-4 overflow-clip">
        <Image src={props.path} alt="next" width={120} height={1} />
      </div>
      <div className="text-2xl font-bold capitalize text-center flex-1 mx-4 flex flex-col justify-center items-center gap-2 py-2 overflow-x-clip">
        <div>{props.name}</div>
